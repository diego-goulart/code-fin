            ...
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    <li v-for="o in config.menus">
                        <a v-if="o.dropdownId" class="dropdown-btn" href="#!" :data-activates="o.dropdownId">
                    ...
                    <li>
                        <a class="dropdown-btn" href="#!" data-activates="dropdown-logout">
...
<script>
    export default{
        ...
        ready(){
            $('.dropdown-btn').dropdown({ hover: true });
